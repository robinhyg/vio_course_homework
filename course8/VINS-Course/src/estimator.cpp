...
bool Estimator::visualInitialAlign()
{
    ...
    // cout << "VisualIMUAlignment_result: " << result << endl;
...
bool Estimator::relativePose(Matrix3d &relative_R, Vector3d &relative_T, int &l)
{
    ...
    for (int i = 0; i < WINDOW_SIZE; i++)
    {
        ...
        if (corres.size() > 20)
        {
            ...
            // cout << "pts_0: " << pts_0.transpose() << endl;
            // cout << "pts_1: " << pts_1.transpose() << endl;
            ...
            cout << "average_parallax: " << average_parallax * 460 << endl;
